...
int main()
{
    ...
    // -------------------------
    shader ourShader("../Homework0/shaders/marry.vs", "../Homework0/shaders/marry.fs");
    shader lightshader("../Homework0/shaders/light.vs", "../Homework0/shaders/light.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        position = glm::vec3(5.0f * sin((float)glfwGetTime()), 3.0f, 5.0f * cos((float)glfwGetTime()));
        ourShader.setVec3("Light.position", position);
